...
Currently the following commands are supported by mock-jedis
 ...
 - SETS: SADD SCARD SDIFF SDIFFSTORE SINTER SINTERSTORE SISMEMBER SMEMBERS SMOVE SPOP SRANDMEMBER SREM SUNION SUNIONSTORE, ZADD, ZINCRBY, ZCARD, ZSCORE, ZRANK, ZREVRANK
